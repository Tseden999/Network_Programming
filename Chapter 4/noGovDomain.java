...
public class noGovDomain {
    public static void main(String[] args) throws Exception {
        ...
        CookieManager cookieManager = new CookieManager(null, (CookiePolicy) policy);
        ...
        boolean result1 = ((CookiePolicy) policy).shouldAccept(uri1, cookie1);
        boolean result2 = ((CookiePolicy) policy).shouldAccept(uri2, cookie2);
