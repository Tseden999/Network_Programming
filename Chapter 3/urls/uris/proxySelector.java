...
public class proxySelector {
    ...
    public static void main(String[] args)
        ...
        // Requiring an proxy for URL
        List<Proxy> nonConfidentialProxies = privateDataProxy.select(
    ...
    private static String getDefault() {
        ...
        throw new UnsupportedOperationException("Unimplemented method 'getDefault'");
    }

    private static void setDefault(PrivateDataProxy privateDataProxy) {
        // TODO Auto-generated method stub
...
public class PrivateDataProxy extends ProxySelector {
    ...
    public PrivateDataProxy() {
        ...
        // https port
        InetSocketAddress inetSocketAddress = new InetSocketAddress("secure.connection.com",
                443);
